function [Aic,Amat,C1mat,C2mat,Dmat,Lmat,Obtrnd] = bnbwcsingle(N,ndes,lengthu,Ntrans,Ncons,iUY,i_UiUj,UYindex,Nworker)
...
szlam = N^2 + (N-N^2)/2;
[Obj_base, Amat_b, C1mat_b, C2mat_b, Dmat_b, lmat_b] = AICc(0, iUY,i_UiUj,UYindex, Ncons, zeros(1,N2), zeros(1,N*lengthu),zeros(1,N*Ntrans),zeros(1,N),zeros(1,szlam));
...
warning('off', 'all')
if flag2
        [a, amat, c1mat, c2mat, dmat, lmat]=AICc(f,iUY,i_UiUj,UYindex,Ncons,amats,c1mats,c2mats,dmats,lmats);
else
    if k==cv
