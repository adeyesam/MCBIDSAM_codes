function [Utranss, iUY, i_UiUj] = InputTransformation(data,uu,IUY,IUU,flag101) %N,lengthu,lengthu2,lenreading)
% For 'first time', all indices of UY and UU to be calculated, afterwardss,
% no need to repeat calculations
    if flag101
        ...
        UY = zeros(size(iUY,1),lenreading);
        for i=1:size(iUY,1)
