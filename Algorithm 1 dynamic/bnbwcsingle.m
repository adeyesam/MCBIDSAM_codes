function [Aic,Amat,Cmat,Lmat,Obtrnd]=bnbwcsingle(N,ndes,Ntrans,Ncons,iUY,i_UiUj,UYindex,Nworker)
...
warning('off', 'all')
if flag2
        [a, amat, cmat, lmat]=AICc(f,iUY,i_UiUj,UYindex,Ncons,amats,cmats,lmats);
else
    if k==cv
