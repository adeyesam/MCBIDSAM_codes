function [Utranss, i_UiUj] = InputTransformation(uu,IUU,flag101)
% For 'first time', all indices of UY and UU to be calculated, afterwardss, no need to repeat calculations
    if flag101
        ...
        if lengthu>1
            Utranss = [UiUj; U2; LogU; ExpU; InvU; InvUsq; sqrtU; sqrtInvU; sigmoidU];
        else
            Utranss = [U2; LogU; ExpU; InvU; InvUsq; sqrtU; sqrtInvU; sigmoidU];
        end
